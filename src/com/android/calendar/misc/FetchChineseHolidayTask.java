...
public class FetchChineseHolidayTask extends AsyncTask<Void, Void, Void> implements
    ...
    public FetchChineseHolidayTask(SharedPreferences prefs, RequestQueue queue, int year) {
        mPrefs = prefs;
        mQueue = queue;
    ...
    private void fetchChineseHoliday(SharedPreferences mPrefs, RequestQueue mQueue) {
        String url = URI.create("http://cloud.mokeedev.com/calendar/ChineseHolidays.php")
                .toASCIIString();
