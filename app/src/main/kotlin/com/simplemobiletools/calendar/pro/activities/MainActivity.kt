...
//            R.id.about -> launchAbout()
    ...
    private fun getHolidayRadioItems(): ArrayList<RadioItem> {
        ...
        LinkedHashMap<String, String>().apply {
            put(getString(R.string.holiday_algeria), "algeria.ics")
            put(getString(R.string.holiday_argentina), "argentina.ics")
            put(getString(R.string.holiday_australia), "australia.ics")
            ...
            put(getString(R.string.holiday_czech), "czech.ics")
            put(getString(R.string.holiday_denmark), "denmark.ics")
            put(getString(R.string.holiday_germany), "germany.ics")
            put(getString(R.string.holiday_estonia), "estonia.ics")
            ...
            put(getString(R.string.holiday_macedonia), "macedonia.ics")
            put(getString(R.string.holiday_malaysia), "malaysia.ics")
            ...
            put(getString(R.string.holiday_austria), "austria.ics")
            put(getString(R.string.holiday_pakistan), "pakistan.ics")
